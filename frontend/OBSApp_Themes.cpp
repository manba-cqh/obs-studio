...
void OBSApp::FindThemes()
{
	...
	{
		const std::string themeDir = App()->userConfigLocation.u8string() + "/HuiXing/themes";
...
bool OBSApp::SetTheme(const QString &name)
{
	...
	string filename("HuiXing/themes/");
...
bool OBSApp::InitTheme()
{
	...
	char userDir[512];
	if (GetAppConfigPath(userDir, sizeof(userDir), "HuiXing/themes")) {
